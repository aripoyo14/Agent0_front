...
export default function DashboardContent({ initialUserName }: DashboardContentProps) {
  const {
    isLoading,
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-4 lg:mb-6 space-y-4 lg:space-y-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-white text-[12px] lg:text-[13.06px] font-semibold tracking-[1.5672px] bg-white/10 rounded-lg px-3 py-2 cursor-pointer hover:opacity-80 transition-colors">
                  {initialUserName}
                </div>
              </div>
            </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center pt-32">
          <div className="w-full max-w-7xl mx-auto px-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
              ...
              <div className="relative group cursor-pointer hover:scale-102 transition-transform duration-150 -mt-8" onClick={navigateToSearch}>
              ...
              <div className="relative group cursor-pointer hover:scale-102 transition-transform duration-150 mt-16" onClick={navigateToPolicy}>
                <div className="relative w-full h-80">
                  <div className="absolute inset-0 flex items-center justify-center z-10 group-hover:scale-105 transition-transform duration-150">
              ...
              <div className="relative group cursor-pointer hover:scale-102 transition-transform duration-150 -mt-16" onClick={navigateToComments}>
                <div className="relative w-full h-80">
                  <div className="absolute inset-0 flex items-center justify-center z-10 group-hover:scale-105 transition-transform duration-150">
                    <div className="relative w-[380px] h-[380px]">
