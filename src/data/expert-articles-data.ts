...
// テーマ名からIDへのマッピングテーブル
export const themeNameToIdMap: Record<string, string> = {
  "経済産業": "1",
  "対外経済": "2",
  "ものづくり/情報/流通・サービス": "3",
  "中小企業・地域経済産業": "4",
...
// 政策テーマのサンプルデータ（バックエンドのIDと一致させる）
export const policyThemes: ExpertPolicyTheme[] = [
  { id: "all", name: "すべて", color: "#007aff", isSelected: true },
  { id: "economy-industry", name: "経済産業", color: "#007aff", isSelected: false },
  { id: "external-economy", name: "対外経済", color: "#00b900", isSelected: false },
  { id: "manufacturing-it-distribution-services", name: "ものづくり/情報/流通・サービス", color: "#007aff", isSelected: false },
  { id: "sme-regional-economy", name: "中小企業・地域経済産業", color: "#00b900", isSelected: false },
  { id: "energy-environment", name: "エネルギー・環境", color: "#af52de", isSelected: false },
  { id: "safety-security", name: "安全・安心", color: "#f59e0c", isSelected: false },
  { id: "digital-transformation", name: "DX", color: "#007aff", isSelected: false },
  { id: "green-transformation", name: "GX", color: "#00b900", isSelected: false },
  { id: "startup-support", name: "スタートアップ支援", color: "#af52de", isSelected: false },
  { id: "diversity-management", name: "ダイバーシティ経営", color: "#f59e0c", isSelected: false },
  { id: "economic-security", name: "経済安全保障", color: "#007aff", isSelected: false },
  { id: "regional-co-creation", name: "地域共創", color: "#00b900", isSelected: false },
  { id: "femtech", name: "フェムテック", color: "#af52de", isSelected: false },
  { id: "data-ai-utilization", name: "データ・AI活用", color: "#f59e0c", isSelected: false },
  { id: "cashless", name: "キャッシュレス", color: "#007aff", isSelected: false },
];
...
export const getArticlesByTheme = (_themeId: string | null): ExpertArticle[] => {
  // 現在はサンプルデータがコメントアウトされているため、空配列を返す
  // 必要に応じて、実際のAPIデータを使用するか、サンプルデータを有効化する
  return [];
  
  // サンプルデータが有効な場合の処理
  // if (!_themeId) return articles;
  // return articles.filter(article => article.themeId === _themeId);
};
...
export const getArticleById = (articleId: string): ExpertArticle => {
  // 現在はサンプルデータがコメントアウトされているため、エラーを投げる
  throw new Error(`Article with id ${articleId} not found - サンプルデータが無効化されています`);
...
export const searchArticles = (_query: string): ExpertArticle[] => {
  // 現在はサンプルデータがコメントアウトされているため、空配列を返す
  return [];
  
  // サンプルデータが有効な場合の処理
  // if (!_query.trim()) return articles;
